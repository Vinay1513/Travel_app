...
import 'package:travel_app/detailScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          Image.asset(
            "assets/images/32badb63498577.5ab28d9d515ac.png",
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset("assets/images/Rectangle 833.png"),
                    Column(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    Image.asset("assets/images/Rectangle 833 (1).png"),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
